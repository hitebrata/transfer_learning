...
# # Using MobileNet for our own Classifer
# 
...
train_data_dir = 'myimage/train/'
validation_data_dir = 'myimage/validation/'
...
checkpoint = ModelCheckpoint("myimage_mobileNet.h5",
                             monitor="val_loss",
                             mode="min",
                             save_best_only = True,
                             verbose=1)
...
classifier = load_model('myimage_mobileNet.h5')
...
myimage_dict = {"[0]": "hitabrata ", 
                "[1]": "margot_robbie"}

myimage_dict_n = {"n01": "hitabrata ", 
                  "n02": "margot_robbie"}

def draw_test(name, pred, im):
    human = myimage_dict[str(pred)]
    BLACK = [0,0,0]
...
def getRandomImage(path):
    ...
    print("Class - " + myimage_dict_n[str(path_class)])
...
for i in range(0,10):
    input_im = getRandomImage("myimage/validation/")
